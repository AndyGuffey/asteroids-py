...
- `constants.py` — game constants (screen size, player radius, line width, turn speed, player speed/acceleration, asteroid sizes/spawn rate, shot speed/cooldown, scoring values, etc.)
